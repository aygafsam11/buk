...
<th><input type="button" class="download" name="download" id="download" value="View SPE-1 Form" style="background-color: blue" onclick="javascript: location.href='admin_print_speform.php?reg_no=<?php echo $x['reg_no'] ?>' ">
</th>
			</tr>
  <?php  } ?>
