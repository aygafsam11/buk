...
error_reporting(0);
    ...
    $sql = "select * from profile, form8, bank where profile.reg_no = '".$_SESSION['reg_no']."'  and bank.reg_no = '".$_SESSION['reg_no']."' and form8.reg_no = '".$_SESSION['reg_no']."' and  profile.status = 1 and form8.spe = 1";
